...
Đặt ngang làm giảm chiều cao so với dựng dọc. Lưng máy hướng đầu xe, màn hình hướng đuôi. Tải truyền qua khay, tháp có giằng, rồi vào chassis; không dùng panel mui làm chân chịu lực. Khay ghép hai beam 13L lệch lớp mỗi mép, chồng 3 lỗ, tổng nhịp 23 stud. Khoảng giữa hai trụ cạnh là 22 stud trong bản dựng; cần căn vị trí lỗ và đệm theo máy thật. Chỉ kẹp cạnh/góc, để thoáng camera, cổng sạc và nút.

Bản cập nhật dùng trực tiếp asset LDraw đã có trong mô hình xe: beam 13L `41239`, 9L `40490`, 11L `32525`, 7L `32524`, chữ L 3 × 5 `32526`, chữ L 2 × 4 `32140`, spacer `18654`, pin 2L `2780` và 3L `6558`. Số lượng trong Advanced được tính từ chính danh sách instance trong `app/phone-mount-parts.ts`. Không có beam, pin hoặc khối nối LEGO tự dựng; mọi mảnh giữ tỷ lệ gốc. Đệm và dây giữ là phụ kiện riêng ngoài LEGO, không được render thành mảnh giả. Chưa chốt vị trí/pin bổ sung gắn xuống chassis đã độ motor. Linh kiện có thể phải mua thêm; mã có trong model không đồng nghĩa xe còn dư mảnh.
